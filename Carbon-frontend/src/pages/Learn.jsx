          ...
          {[
            {
              ...
              body: "Click on Register to sign up with your email. Once registered, you can log in securely and begin tracking your footprint.",
            },
            {
              title: "2. Log Your Activities",
              body: "Head to the Log Activity page to enter details about your transportation, food habits, energy usage, and more. The system will calculate the CO₂ emissions for each.",
            },
            {
              title: "3. Monitor Your Dashboard",
              body: "On the Dashboard, view charts that track your emissions by category and over time. Get insights and suggestions based on your habits.",
            },
            {
              title: "4. Set Weekly Goals",
              body: "Use the Goals page to set your CO₂ reduction goals. Your weekly summary will help you track progress toward a more sustainable lifestyle.",
            },
            {
              title: "5. Earn Achievements",
              body: "Get rewarded for consistency and hitting targets! The Achievements section celebrates your journey with badges and milestones.",
            },
            {
              title: "6. Compete on the Leaderboard",
              body: "See how your efforts stack up against others on the Leaderboard. Friendly competition motivates sustainable change!",
            },
            {
              title: "7. Update Your Profile",
              body: "Manage your information and preferences from the Profile section. You can also change your password and upload a profile picture.",
            },
          ].map((item, idx) => (
            <motion.section
              key={item.title}
