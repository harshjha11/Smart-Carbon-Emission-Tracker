      ...
      <div className="max-w-2xl mx-auto px-6 pt-12 pb-20 relative">
        ...
        >
          ...
          <p className="text-slate-600 dark:text-white text-base md:text-lg max-w-md mx-auto leading-relaxed">
            Define your carbon emission target for the week and track your
            progress towards a sustainable lifestyle.
          </p>
        </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <p className="mt-3 text-sm text-slate-500 leading-relaxed">
                💡 Average Indian weekly carbon footprint is around 150-200 kg
                CO₂. Set a challenging but achievable target!
              </p>
            </div>
                    ...
                    <p className="text-base text-slate-700 leading-relaxed">
                      {parseFloat(goalInput) <= 50 && (
                        <span>
                          ...
                          This is a very ambitious target. You&apos;ll need to
                      ...
                      {parseFloat(goalInput) > 50 &&
                        parseFloat(goalInput) <= 100 && (
                          <span>
                            ...
                            This is a challenging but achievable target with
                            consistent effort.
                          </span>
                        )}
                      {parseFloat(goalInput) > 100 &&
                        parseFloat(goalInput) <= 150 && (
                          <span>
                            ...
                            This is a moderate goal. Consider lowering it as you
                            build habits.
                          </span>
                        )}
                      {parseFloat(goalInput) > 150 && (
                        <span>
                          ...
                          This is a relaxed target. Great for beginners just
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-base text-slate-700 leading-relaxed">
                  ...
                  Setting a weekly carbon goal helps you stay accountable and
                  motivated. Track your progress on the Dashboard and earn
                  achievements as you reduce your footprint!
                </p>
              </div>
            </div>
          </motion.div>
