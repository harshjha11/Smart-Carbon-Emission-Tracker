    ...
    <div className="min-h-screen relative overflow-hidden text-base md:text-lg">
      ...
      <div className="max-w-5xl mx-auto px-6 pt-12 pb-20 relative">
        ...
        >
          ...
          <p className="text-slate-600 dark:text-white text-base md:text-lg max-w-md mx-auto leading-relaxed">
            Balance your carbon footprint by supporting activities that remove
        ...
        >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                >
                  ...
                  <p className="text-3xl font-bold text-green-700 mb-1">
                    {offsetData?.offsetOptions?.monthlyOffset?.treesRequired
                      ?.count || 0}
                  </p>
                  <p className="text-base text-slate-500 mb-4">trees/month</p>
                  <p className="text-sm text-slate-500 leading-relaxed mt-auto">
                    Trees absorb CO₂ throughout their lifetime. Planting trees
                    is a long-term investment in our planet&apos;s health.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed mt-auto">
                    Contribute to renewable energy projects. Actual costs may
                  ...
                  <div className="flex flex-wrap justify-center gap-6 mb-1">
                    <div>
                      <p className="text-3xl font-bold text-purple-700">
                        {offsetData?.offsetOptions?.lifestyleActions
                          ?.cyclingDays?.count || 0}
                      </p>
          ...
          {!loading &&
            !error &&
            offsetData &&
            offsetData?.offsetOptions?.yearlyOffset && (
              <>
                ...
                >
                  ...
                  <div className="p-5 rounded-2xl bg-gradient-to-r from-blue-50 to-emerald-50 border border-slate-200">
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold text-emerald-700">
                          {offsetData.offsetOptions.yearlyOffset.treesRequired
                            ?.count || 0}
                    ...
                    <p className="text-sm text-slate-500 mt-4">
                      * Based on your current monthly emissions extrapolated
                      over 12 months.
                    </p>
                  </div>
                </motion.div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-lg text-slate-700 leading-relaxed">
                  <span className="font-bold text-emerald-700">Remember:</span>{" "}
                  Offsetting is valuable, but reducing your emissions at the
                  source is always the best approach. Use these offsets as a
                  complement to sustainable lifestyle choices, not a
                  replacement.
                </p>
              </div>
            </div>
          ...
          >
            ⚠️ All offset values are approximations for educational and
            awareness purposes only. Actual requirements may vary based on tree
            species, location, and energy sources.
          </motion.p>
