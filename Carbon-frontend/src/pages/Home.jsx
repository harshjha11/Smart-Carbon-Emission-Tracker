...
import pollution from "../assets/pic3_poll.jpg";
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-12 space-y-16 md:space-y-20 lg:space-y-24 relative">
        ...
        <motion.section
          className="grid gap-8 lg:gap-12 md:grid-cols-2 items-center pt-8"
          initial={{ opacity: 0, y: 24 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
          {/* Text side (left) with Subheadline */}
          <div className="space-y-5 order-1 md:order-1 md:-ml-8">
            <motion.span
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-700 to-cyan-800 dark:from-emerald-400 dark:to-teal-400">
                carbon footprint
              </span>{" "}
              and shift towards a cleaner, more sustainable lifestyle.
            </motion.h1>

            {/* NEW: Subheadline */}
            <motion.p
              className="text-lg md:text-xl lg:text-2xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-green-700 via-teal-600 to-cyan-800 dark:from-emerald-400 dark:via-teal-500 dark:to-cyan-400 italic"
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              Every small step counts. Together, we build a greener India.
            </motion.p>

            <motion.p
              className="text-sm md:text-base lg:text-lg text-slate-600 dark:text-white max-w-2xl"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.5, delay: 0.25 }}
            >
              Track your daily habits, understand their environmental impact,
              and get smart, personalized recommendations to embrace
              eco-friendly and renewable choices for a better tomorrow.
            </motion.p>
            ...
            >
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-full border-2 border-emerald-700 dark:border-emerald-400 px-7 py-2.5 text-sm md:text-base font-semibold text-green-600 dark:text-emerald-400 hover:bg-emerald-50 hover:-translate-y-0.5 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
              >
                Learn More
              </button>
            </motion.div>
          </div>
          {/* Illustration (right) with Glow and Floating Animation */}
          <motion.div
            className="h-full flex items-center justify-center order-2 md:order-2"
        ...
        >
          {/* Did You Know */}
          <div className="order-2 rounded-3xl bg-white/80 backdrop-blur-sm shadow-xl shadow-emerald-100/30 border border-emerald-100 p-6 flex flex-col justify-between h-full">
            <div className="space-y-4">
              <h2 className="text-xl md:text-2xl font-bold text-emerald-600/90 flex items-center gap-3">
                <span className="w-10 h-10 rounded-full bg-gradient-to-br from-yellow-400 to-yellow-400 flex items-center justify-center text-lg shadow-lg shadow-amber-200">
                  💡
                </span>
                Did You Know?
              </h2>
              ...
              <p className="text-sm md:text-base text-slate-800">
                Small, meaningful habits can reduce your yearly carbon
                footprint.
              </p>

              <motion.div
                key={factIndex}
                className="text-base md:text-lg text-white bg-gradient-to-br from-emerald-800 to-teal-400 border border-emerald-100 rounded-2xl px-5 py-4 leading-relaxed shadow-inner"
          ...
          <div className="order-1 rounded-3xl bg-gradient-to-br from-emerald-800 via-emerald-400 to-teal-800 text-emerald-50 shadow-xl shadow-emerald-200 p-6 flex flex-col justify-between h-full relative overflow-hidden">
            {/* Background Pattern */}
        ...
        <motion.section
          className="relative rounded-[2rem] overflow-hidden hover:from-emerald-500 hover:to-teal-900
                       hover:shadow-lg hover:shadow-emerald-800
        ...
        >
          {/* Background */}
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-800 via-teal-400 to-green-800" />
          ...
          {/* Decorative Elements */}
          <svg
            className="absolute top-8 left-8 w-16 h-16 text-emerald-300/40"
            viewBox="0 0 24 24"
            fill="currentColor"
          >
            <path d="M17,8C8,10 5.9,16.17 3.82,21.34L5.71,22L6.66,19.7C7.14,19.87 7.64,20 8,20C19,20 22,3 22,3C21,5 14,5.25 9,6.25C4,7.25 2,11.5 2,13.5C2,15.5 3.75,17.25 3.75,17.25C7,8 17,8 17,8Z" />
          ...
          <svg
            className="absolute bottom-8 right-8 w-20 h-20 text-teal-300/30 rotate-180"
            viewBox="0 0 24 24"
            fill="currentColor"
          >
            <path d="M17,8C8,10 5.9,16.17 3.82,21.34L5.71,22L6.66,19.7C7.14,19.87 7.64,20 8,20C19,20 22,3 22,3C21,5 14,5.25 9,6.25C4,7.25 2,11.5 2,13.5C2,15.5 3.75,17.25 3.75,17.25C7,8 17,8 17,8Z" />
          ...
          <div className="relative px-8 py-16 md:px-16 md:py-20 lg:py-24">
            <div className="max-w-5xl mx-auto text-center space-y-8">
              <motion.p
                className="text-sm md:text-base font-bold tracking-[0.25em] uppercase text-emerald-200"
                initial={{ opacity: 0, y: 10 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                <span className="block text-emerald-800/60 text-6xl md:text-7xl lg:text-8xl font-serif">
                  ❝
                </span>

                <p className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight text-emerald-800">
                  The planet doesn’t need a few perfect people
                </p>

                <p className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight">
                  <span className="relative inline-block  text-emerald-200">
                    it needs millions taking small, imperfect steps.
              ...
              <motion.p
                className="text-base md:text-lg lg:text-xl text-emerald-200 max-w-3xl mx-auto leading-relaxed"
                initial={{ opacity: 0, y: 10 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-3">
                <motion.span
                  className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-red-500 to-amber-500 px-4 py-1.5 text-xs md:text-sm font-semibold text-yellow-50 shadow-sm hover:shadow-md transition-shadow duration-300"
                  initial={{ opacity: 0, y: 10 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                ...
                >
                  ...
                  The Hidden Human Cost of Pollution
                </motion.span>

                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white leading-tight">
                  Why It{" "}
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-700 via-yellow-500 to-amber-600/40">
                    Matters
                  </span>{" "}
                  More Than Ever
                </h2>
              ...
              {/* Emotional content */}
              <div className="space-y-4 text-lg md:text-xl text-slate-700 dark:text-white">
                {/* <motion.p
                ...
                > */}
                <p>
                  Children are the silent victims of rising pollution levels.
                  Their developing lungs and immune systems make them far more
                  vulnerable, causing them to absorb more harmful pollutants
                  than adults and suffer deeper, long-term consequences.
                </p>
                <br />
                <p>
                  Every breath they take is shaped by the environment we create
                  today. The choices we make in our daily lives, how we travel,
                  consume energy, and live directly influence the quality of air
                  they breathe and the future they inherit.
                </p>
                <br />
                <p>
                  This is not just an environmental issue; it is a human
                  responsibility. A healthier, cleaner world begins with the
                  actions we take now for them, and for generations to come.
                </p>
                {/* </motion.p> */}
              </div>
                ...
                <div className="inline-flex items-center gap-3 px-5 py-3 rounded-2xl bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 shadow-sm">
                  ...
                  <p className="text-sm md:text-base font-medium text-slate-700">
                    <span className="text-emerald-700 font-semibold">
                      Your sustainable choices today
                    </span>{" "}
                    protect the next generation tomorrow.
                  </p>
                </div>
              </motion.div>
            </motion.div>
        ...
        >
          <div className="text-center space-y-4">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white">
              Building a{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-emerald-600 to-green-600 dark:from-orange-400 dark:via-emerald-400 dark:to-green-400">
                Self-Reliant India
              </span>
            </h2>

            <p className="text-base md:text-lg text-slate-600 max-w-3xl mx-auto dark:text-white">
              Meet the pioneers driving India&apos;s sustainable future through
              indigenous innovation, renewable energy research, and climate
              advocacy.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:gap-8 lg:grid-cols-3">
            {atmanirbharCards.map((card, idx) => (
              ...
              >
                ...
                />
                <div
                  className={`absolute inset-0 ${card.bgPattern} group-hover:opacity-0 transition-opacity duration-500`}
                />
                ...
                <div className="absolute inset-0 opacity-5 group-hover:opacity-10 transition-opacity">
                  <svg className="w-full h-full" viewBox="0 0 100 100">
                    ...
                    <rect
                      width="100"
                      height="100"
                      fill={`url(#pattern-changemaker-${idx})`}
                    />
                  </svg>
                </div>
        ...
        {/* Quick Actions */}
        <motion.section
          className="rounded-3xl bg-indigo-200/20 backdrop-blur-sm shadow-xl shadow-emerald-100/30 border border-slate-100 p-6 md:p-8"
          initial={{ opacity: 0, y: 24 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.2 }}
          transition={{ duration: 0.6 }}
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm md:text-base text-slate-500 mt-1 dark:text-white">
        ...
        >
          {/* Background */}
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-800 via-teal-400 to-emerald-800" />
          ...
          <div className="relative p-8 md:p-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div className="max-w-2xl">
              <p className="text-sm font-bold uppercase tracking-wider text-emerald-950 dark:text-black">
                Begin Your Journey Today
              </p>
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mt-3 text-white">
                Start by tracking your everyday activities, set practical goals,
                and gradually shift towards renewable and Swadeshi energy
                choices.
              </h2>
              <p className="text-base md:text-lg font-poppins text-emerald-950 mt-4 leading-relaxed dark:text-black">
                With this platform, you can clearly see your impact making it
                easier to stay aware, stay consistent, and make better decisions
