      ...
      <div className="max-w-5xl mx-auto px-6 pt-12 pb-20 relative">
        ...
        >
          ...
          <p className="text-slate-600 text-base md:text-lg max-w-xl mx-auto dark:text-white">
            See how you rank among other eco-conscious users! Compete for the
            top spot by reducing your carbon footprint.
          </p>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-slate-500">Lowest CO2</p>
                </div>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Ranked by lowest weekly CO2 emitted
                </p>
              </div>
            </div>
            {users.length > 0 && (
          ...
          {loading ? (
            ...
            >
              ...
              <p className="text-slate-500 max-w-md mx-auto mb-6">
                The leaderboard is waiting for its first eco-warriors! Start
                logging your sustainable activities to appear here and compete
                with others.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Track your daily impact",
                  },
                  {
                    emoji: "🎯",
                    title: "Set Goals",
                    desc: "Challenge yourself weekly",
                  },
                  {
                    emoji: "📉",
                    title: "Reduce CO₂",
                    desc: "Lower your footprint",
                  },
                ].map((tip, index) => (
                  <motion.div
                    key={index}
                    ...
                    >
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-4">
                          <div
                            className={`w-11 h-11 rounded-full overflow-hidden flex items-center justify-center font-bold text-sm transition-transform duration-300 group-hover:scale-110 ${
                              idx === 0
            ...
            <div className="flex flex-col md:flex-row items-center gap-4">
              ...
              <div className="text-center md:text-left flex-grow">
                ...
                <p className="text-sm text-slate-600">
                  Keep logging your eco-friendly activities to improve your
                  ranking. Every action counts towards a greener planet!
                </p>
              </div>
              <motion.button
                onClick={() => navigate("/activity")}
          ...
          <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-slate-400">
                Made with <span className="text-red-500">❤️</span> in India for
