          ...
          <div className="flex items-center gap-2">
            ...
            {!otpVerified && (
              <button
                ...
                className="px-3 py-2 rounded bg-emerald-600 text-white text-sm font-medium hover:bg-emerald-700 transition disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
              >
